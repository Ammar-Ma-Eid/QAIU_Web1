// This file has been migrated to /client/src/app/events/[id]/page.tsx
...
export default function EventDetailPage({ params }: PageProps) {
  ...
  useEffect(() => {
    setLoading(true);
    fetcher('/api/events').then(data => {
      setEvents(data);
      setLoading(false);
    });
  }, []);
  const event = events.find((e: any) => String(e.id) === String(params.id));
