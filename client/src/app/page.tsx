    ...
    <div className="relative w-full overflow-hidden">
      ...
      <section className="relative">
        ...
        <div className="relative z-10 container mx-auto px-4 py-32 md:py-48 text-center">
          ...
          <p className="max-w-4xl mx-auto text-xl md:text-2xl text-muted-foreground mb-10">
      ...
      <div className="relative container mx-auto pb-20 md:pb-32">
        <div className="relative h-96 w-full flex items-center justify-center">
          <Image src="/pic1.jpg" alt="QAIU Event 1" width={450} height={300} className="absolute rounded-lg shadow-2xl animate-float-1" />
          <Image src="/pic2.jpg" alt="QAIU Event 2" width={400} height={270} className="absolute left-1/3 rounded-lg shadow-2xl animate-float-2" style={{ left: '40%' }} />
          <Image src="/pic3.jpg" alt="QAIU Event 3" width={370} height={270} className="absolute left-2/3 rounded-lg shadow-2xl animate-float-3" style={{ left: '30%' }} />
        </div>
      </div>
