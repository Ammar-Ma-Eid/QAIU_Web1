        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {quantumJobs.map((job, index) => (
            <div key={index} className="group relative">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-800 to-sky-500 rounded-lg blur opacity-20 group-hover:opacity-60 transition duration-1000 group-hover:duration-200"></div>
