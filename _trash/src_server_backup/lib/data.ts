// This file has been migrated to /client/src/lib/data.ts
...
export const blogPosts = [
  { id: '1', title: 'Understanding Qubits: Beyond 0 and 1', author: 'Alice', date: '2024-09-01T11:00:00Z', excerpt: 'A fundamental look into the building blocks of quantum computers and what makes them so powerful.', imageUrl: 'https://placehold.co/600x400', content: 'This is a placeholder content for Understanding Qubits.' },
  { id: '2', title: "My Journey into Quantum: A Student's Perspective", author: 'Charlie', date: '2024-08-22T15:00:00Z', excerpt: 'Discover how a computer science student found a passion for the quantum realm.', imageUrl: 'https://placehold.co/600x400', content: 'This is a placeholder content for My Journey into Quantum.' },
  {
    id: '3', title: 'Can Quantum Computers Break Cryptography?', author: 'Bob', date: '2024-08-15T10:00:00Z', excerpt:
      "Exploring Shor's algorithm and the implications of quantum computing for modern-day security.", imageUrl: 'https://placehold.co/600x400', content: 'This is a placeholder content for Can Quantum Computers Break Cryptography?'
  },
];
